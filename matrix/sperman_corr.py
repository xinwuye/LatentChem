...
if __name__ == "__main__":
    # 替换为你的实际文件路径
    csv_file_1 = "/zengdaojian/zhangjia/BioLatent/Bio-LatentCOT/eval/silmilarity_matrix/molecular_similarity_matrix_qed_withnumber.csv"   # 例如 RDKit 指纹相似度
    csv_file_2 = "/zengdaojian/zhangjia/BioLatent/Bio-LatentCOT/eval/silmilarity_matrix/qwen3_smiles_similarity_prompt.csv"   # 例如 Qwen3 embedding 相似度
