...
json_objects = []
with open('/zengdaojian/zhangjia/BioLatent/Bio-LatentCOT/new_latent/stage3_latent_logp.jsonl', 'r', encoding='utf-8') as f:
    for line in f:
        line = line.strip()
        if line:
            obj = json.loads(line)
...
with open('/zengdaojian/zhangjia/BioLatent/Bio-LatentCOT/eval/silmilarity_matrix/sorted_data_logp.jsonl', 'w', encoding='utf-8') as f:
