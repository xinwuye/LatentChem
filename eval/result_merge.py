...
def main():
    import sys
    # Expecting two command line arguments: input path and output path
    if len(sys.argv) != 3:
        print("Usage: python result_merge.py <input_path> <output_path>")
        print("Example: python result_merge.py ./results ./merged_output.json")
        return
