...
RESULT_PATH="/zengdaojian/zhangjia/BioLatent/Bio-LatentCOT/outputs/exp_chemllmbench_stage4_1_5_no/results/merge.json"
...
NUM_SAMPLES=1
MODE="record"
# result_dir="/zengdaojian/zhangjia/BioLatent/Bio-LatentCOT/outputs/exp_chemllmbench_stage4_0_7_no/results/merge.json"
