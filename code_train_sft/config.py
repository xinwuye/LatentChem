...
class ModelConfig:
    ...
    # Qwen 模型路径
    DEFAULT_QWEN_PATH = os.path.abspath(os.path.join(CURRENT_DIR, "/BioLatent/Bio-LatentCOT/models/Qwen3-8B-Base"))
    
    # SMI-TED 模型文件夹和权重文件名
    DEFAULT_SMI_TED_FOLDER = os.path.abspath(os.path.join(CURRENT_DIR, "/BioLatent/Bio-LatentCOT/models/smi-ted"))
